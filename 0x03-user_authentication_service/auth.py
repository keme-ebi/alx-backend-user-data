...
class Auth:
    ...
    def update_password(self, reset_token: str, password: str) -> None:
        """updates the user's hashed_password with the new hashed password
        Arg:
            reset_token(str): token to find the corresponding user
            password(str): password to hash and update
        Return:
            None
        """
        try:
